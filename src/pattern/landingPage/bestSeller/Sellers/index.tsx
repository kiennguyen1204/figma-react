            ...
            <div className="sellerListContainerBox">
                <div className="bestSellerCard">
                    <div className="bestSellerCardImage">
                        <img width={213} height={213} decoding="async" loading="lazy" src={BestProduct} className="bestProductImage" alt="" />
                    </div>
                    ...
                    <div className="sellerCardContent">
                        ...
                        <div className="bestSellerCardDescription">
                            ...
                            <div className="bestSellerCardButton">
                                <Link to="/" className="baseSellerLink">View All</Link>
                            </div>
                        </div>
                                            ...
                                            <div className="sellContainerBoxContent mt-4">
                                                ...
                                                <div className="flexBox">
                                                    <div className="rateBox">
                                                        ...
                                                        <span className="rateText">{el.rate}</span>
                                                    </div>

                                                    <div className="reviewBox">
                                                        <div className="reviewText">{el.reviews} <span className="reviews">Reviews</span></div>
                                                    </div>
                                                </div>

                                                <div className="saleBox">
                                                    <span className="saleText">{el.sale}</span>
                                                </div>

                                                <div className="priceBox">
                                                    {el.discount && <span className="discount">{el.discount}</span>}
                                                    <span className="priceText">{el.price}{el.unit && <span className="unit"> / {el.unit}</span>}</span>
